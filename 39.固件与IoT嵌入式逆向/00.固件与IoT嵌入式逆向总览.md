...
| # | 章节 | 说明 |
| --- | --- | --- |
| 16 | [[16.SDR与射频信号逆向]] | SDR 硬件、GNU Radio、调制解调、URH、重放/滚动码 |
| 17 | [[17.硬件侧信道与故障注入]] | DPA/CPA、ChipWhisperer、电压/时钟毛刺、AES 恢复（防御）|
| 22 | [[22.eMMC与NAND芯片级取证]] | chip-off/ISP、NAND ECC/OOB/加扰、FTL、取证重组 |

## 十、协议与平台专项（扩展）

| # | 章节 | 说明 |
| --- | --- | --- |
| 18 | [[18.工业控制协议逆向]] | Modbus/DNP3/OPC-UA/S7、Purdue 模型、ICS 防御 |
| 19 | [[19.车载总线与汽车ECU逆向]] | CAN/CAN-FD、ISO-TP、UDS、Seed-Key、SocketCAN |
| 20 | [[20.UEFI与BIOS固件逆向]] | SEC/PEI/DXE、SMM、UEFITool、efiXplorer、Bootkit |
| 21 | [[21.安全启动链绕过技术]] | 信任根、checkm8 类、TOCTOU、回滚、故障注入（防御）|
| 24 | [[24.BMC与IPMI服务器带外管理]] | ASPEED、IPMI/RAKP、Cipher 0、OpenBMC、Redfish |

## 十一、仿真·供应链·专项（扩展）

| # | 章节 | 说明 |
| --- | --- | --- |
| 23 | [[23.固件仿真进阶Qiling与HALucinator]] | Qiling、裸机仿真、HALucinator、Fuzzware、仿真+fuzzing |
| 25 | [[25.固件供应链与SBOM分析]] | 成分分析、SBOM、EMBA/FACT、CVE 关联、SLSA |
| 26 | [[26.工控与无人机专项逆向]] | MC7/Codesys、DJI/DUML、MAVLink、GPS 欺骗（防御）|
