...
## 4. Cortex-A（AArch32 与 AArch64）详解

### 4.1 AArch32 寄存器集与处理器模式
...
### 4.2 寄存器对照表：M vs A（AArch32）vs A（AArch64）
...
### 5.3 在 IDA Pro 中切换 Thumb/ARM 识别
...
### 7.2 在 Ghidra 中逆向 ARM Linux ELF（AArch32/AArch64）
...
### 8.2 AArch64 Pointer Authentication（PAC）
...
### 8.3 BTI（Branch Target Identification）
