...
| # | 章节 | 说明 |
| --- | --- | --- |
| 14 | [[14.Windows启动链BOOTMGR与winload]] | UEFI→bootmgr→winload→ntoskrnl、BCD、ELAM、BitLocker、PatchGuard |
| 15 | [[15.macOS启动链iBoot与kernelcache]] | SecureROM→iBoot、Image4、SEP、kernelcache、SSV、Apple Silicon |
| 16 | [[16.Android启动链AVB与vbmeta]] | ATF→ABL、AVB 2.0、vbmeta、dm-verity、A/B 分区（防御视角）|

## 七、启动进阶专题（扩展）

| # | 章节 | 说明 |
| --- | --- | --- |
| 17 | [[17.休眠与恢复S4与hiberfil]] | ACPI S3/S4、hiberfil.sys、swsusp、恢复路径、镜像取证 |
| 18 | [[18.kexec与kdump崩溃转储]] | kexec 直接换内核、crashkernel、vmcore、crash 工具分析 |
| 19 | [[19.initramfs与early_userspace]] | cpio rootfs、dracut hooks、switch_root、LUKS/网络根 |
| 20 | [[20.多重引导与虚拟化引导]] | GRUB chainload、efibootmgr、Xen、KVM/OVMF、PVH、cloud-init |
| 21 | [[21.coreboot与LinuxBoot开源固件]] | coreboot 阶段、FSP、payload、LinuxBoot、Heads、flashrom |
